...
#define MAX_HASH_IN_BUFFER 1000
...
private:
    ...
    unsigned int hashFound;
    unsigned int hashMissed;
    int hashBuffered;
    unsigned int hashBuffer[ 1000 ];

    inline bool addToBuffer( unsigned int id );
    inline unsigned int getFromBuffer();
//    int64 c;
//    int64 start;
//    int64 end;
};
